...
const TerniumBanner = () => {
  ...
  return (
    <div className="flex h-auto w-screen items-center justify-center gap-4 bg-orange-600/60 bg-cover bg-fixed bg-top bg-no-repeat text-xl text-white sm:h-[35vh] sm:bg-[url('/img/ternium_acero_foto-home.jpg')] md:-mt-20 md:h-[60vh] md:bg-center lg:text-2xl">
